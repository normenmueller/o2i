...
\node[state, below=1.55cm of visible] (relevant) {
...
\draw[flow] (visible) -- node[gate] {
  {\color{omuted}Bedarfsqualifikation}\\[-1pt]
  \texttt{qualifyingStrategies}
} (relevant);
...
\draw[flow] (traceable) -- node[gate] {
  {\color{omuted}Evidenzplan, Baseline und geplanten Beginn festlegen}\\[-1pt]
