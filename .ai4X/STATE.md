...
Implement and narrowly verify Batch `#35` without changing profile, adapter, Views, reference models, or publication artifacts.
...
- Scope: Core collective fan-in types, validation, indexing, diagnostics, metrics, and focused tests
- Revision: `UNAVAILABLE` until the Batch 1 candidate commit exists
- Mandatory checks: focused Core tests, complete Haskell verification, independent Formalization/Haskell batch review
- Finding status: `OPEN`
- Result: `PENDING`
