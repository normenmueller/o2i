...
> Generated review snapshot of `O2I Syntax - Carriers` from `meta/o2i.archimate`.
> Review artifact only; exact syntax mapping authority is `spec/ctr/archimate/profile.json`.

## View Contract

Visualizes the carrier mappings of the concrete ArchiMate profile defined by spec/ctr/archimate/profile.json.
