...
> Generated review snapshot of `O2I Syntax - Relations` from `meta/o2i.archimate`.
> Review artifact only; exact syntax mapping authority is `spec/ctr/archimate/profile.json`.

## View Contract

Visualizes the relation-representation families of the concrete ArchiMate profile defined by spec/ctr/archimate/profile.json.
...
- `ArchiMate Grouping (source)` --<O2I relation name>--> `ArchiMate Grouping (target)` (RealizationRelationship)
