...
Weiterlesen: [Ethos](../paper/o2i.md#ethos)
...
Weiterlesen: [Mission](../paper/o2i.md#mission)
...
Weiterlesen: [Vision](../paper/o2i.md#vision)
...
Spezifikation: [`assessSemantics`](../../spec/lib/core/src/O2I/Semantics.hs)

Weiterlesen: [Strategie](../paper/o2i.md#strategie)
...
`assessSemantics` prüft die modellinterne Kontextsemantik und sämtliche kollektiven Claims an der vollständigen Modellgrenze; bereitgestellte Strategy-Formulierungen und kollektive Fits bewertet es ergänzend. Candidates bleiben diagnostizierbar; ohne gültige modellinterne Kontextsemantik wird ihre fachliche Bewertung ausdrücklich als blockiert ausgewiesen. Fehlerhafte Claims führen zur Ablehnung, die keinen `SemanticallyValidModel` offenlegt. Jedes nicht abgelehnte Assessment legt denselben opaken Modellbeweis aus wohlgeformtem Graphen und global situierten Needs offen; fehlen optionale Strategy-Formulierungen oder kollektive Fits, bleiben nur die betroffenen Assessments nicht verfügbar. Gültige Strategy-Formulierungen und validierte kollektive Realisierungen bleiben eigene Assessment-Ergebnisse und sind keine Bestandteile des Modellbeweises. Eine direkte binäre `Strategy --realizes--> Strategy`-Relation ist unzulässig; `directs` und `contributes-to` behalten ihre jeweils eigene Bedeutung.

Spezifikation: [`assessSemantics`](../../spec/lib/core/src/O2I/Semantics.hs), [`semanticallyValidCollectiveRealizations`](../../spec/lib/core/src/O2I/Semantics.hs)

Weiterlesen: [Strategiebeitrag und kollektive Strategierealisierung](../paper/o2i.md#strategiebeitrag-und-kollektive-strategierealisierung), [Kollektive Strategierealisierung im Metamodell](../paper/o2i.md#kollektive-strategierealisierung)
...
Weiterlesen: [Situation](../paper/o2i.md#situation)
...
Weiterlesen: [Bedarf](../paper/o2i.md#bedarf)
...
Spezifikation: [`O2I.Qualification`](../../spec/lib/core/src/O2I/Qualification.hs)
...
Weiterlesen: [Bedarfsqualifikation](../paper/o2i.md#bedarfsqualifikation), [Evidenzbereitschaft](../paper/o2i.md#evidenzbereitschaft)
...
Spezifikation: [`O2I.Qualification`](../../spec/lib/core/src/O2I/Qualification.hs), [`O2I.Semantics`](../../spec/lib/core/src/O2I/Semantics.hs)

Weiterlesen: [Bedarfsqualifikation](../paper/o2i.md#bedarfsqualifikation), [Wirkungsrelevanz](../paper/o2i.md#wirkungsrelevanz)
...
Spezifikation: [`assessSemantics`](../../spec/lib/core/src/O2I/Semantics.hs), [`assessTraceability`](../../spec/lib/core/src/O2I/Trace.hs), [`assessReadiness`](../../spec/lib/core/src/O2I/Readiness.hs)

Weiterlesen: [Intervention](../paper/o2i.md#intervention)
...
Weiterlesen: [Messung](../paper/o2i.md#messung)
...
Spezifikation: [`assessReadiness`](../../spec/lib/core/src/O2I/Readiness.hs)

Weiterlesen: [Evidenzbereitschaft](../paper/o2i.md#evidenzbereitschaft), [Nachweislogik](../paper/o2i.md#nachweislogik)
...
Spezifikation: [`assessTraceability`](../../spec/lib/core/src/O2I/Trace.hs) -> [`assessReadiness`](../../spec/lib/core/src/O2I/Readiness.hs) -> [`O2I.Assessment`](../../spec/lib/core/src/O2I/Assessment.hs)

Weiterlesen: [Nachweislogik](../paper/o2i.md#nachweislogik), [Wirkungstrace](../paper/o2i.md#wirkungstrace), [Wirkungsevidenz](../paper/o2i.md#wirkungsevidenz), [Plausible Attribution](../paper/o2i.md#plausible-attribution)
...
Spezifikation: [`Commitment`](../../spec/lib/core/src/O2I/Core/Graph/Commitment.hs), [`assessSemantics`](../../spec/lib/core/src/O2I/Semantics.hs)

Weiterlesen: [Claims](../paper/o2i.md#claims), [Modellzustand](../paper/o2i.md#modellzustand)
