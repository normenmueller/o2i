...
- Reworked the Haskell specification under `spc/` into a Library-first Cabal project with typed graphs, an explicit graph/model validation boundary, total relation registries, four-stage validation of structure, semantics, traceability, and evidence, separate effect and target assessment, and tests.
